...
Prefer daisyUI components for standard UI patterns when they fit the desired
behavior and visual design. Compose them with Tailwind utilities rather than
