...
The canonical description of what fuda does now: externally observable
behavior, product rules, invariants, wire contracts and security constraints.
Code comments cite these files by section, and tests are checked against them.
The system overview, component map and trust boundaries live in the
